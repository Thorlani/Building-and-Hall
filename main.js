...
const building = new URL("building/scene.gltf", import.meta.url);
...
const planeMesh = new THREE.Mesh(
  new THREE.PlaneGeometry(22, 22, 512, 512),
...
const grid = new THREE.GridHelper(22, 22);
